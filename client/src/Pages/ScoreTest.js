            ...
            <div className="scoreHeader">
              <Grid container alignItems="center">
                ...
                <Grid
                  ...
                  sm={4}
                  md={4}
                  style={{ textAlign: "right", marginLeft: "1.5rem" }}
                >
                ...
                <Grid
                  ...
                  sm={4}
                  md={4}
                  style={{ textAlign: "right", marginLeft: "-11.8rem" }}
                >
              ...
              <Paper key={index} elevation={3} className="scorePaper">
                ...
                >
                  ...
                  <Grid
                    ...
                    sm={4}
                    md={4}
                    style={{ textAlign: "right", marginRight: "-150px" }}
                  >
                    <Typography
                      variant="body1"
                      style={{ fontSize: "16px" }}
                    >{`${score.questionsCorrect}/${score.totalQuestions}`}</Typography>
                  </Grid>
                  <Grid
                    item
                    xs={3}
                  ...
                  >
                    <Typography
                      variant="body1"
                      style={{ fontSize: "16px" }}
                    >{`${score.score}/${score.totalScore}`}</Typography>
                  </Grid>
                </Grid>
              </Paper>
            ))}
