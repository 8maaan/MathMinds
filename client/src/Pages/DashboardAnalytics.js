...
import { DashboardRecentActivity, FirstDashboardDefaultView } from '../ReusableComponents/DashboardContents/TeacherDashboard';
            ...
            <Box className='dap-right-side'>
                <Box className='dap-analytics-container'>
                  ...
                  <Box className='dap-toggleBtnGrp-container'>
                    <ToggleButtonGroup color="primary" value={btnGroupAlignment} exclusive onChange={handleChange}>
